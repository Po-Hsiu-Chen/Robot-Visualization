...
float ds = 0.0, dt = 0.0;
float head = 0.0, up = 0.0, roll = 0.0, zoom = 0.0, Epitch = 0.0, right = 0.0, left = 0.0, Wpitch = 0.0;
/*----------------------------------------------------------
...
void myinit() {
    ...
    // assign image data
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, SIZE0, SIZE0, 0, GL_RGBA, GL_UNSIGNED_BYTE, checkboard);
    ...
    */
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, SIZE0, SIZE0, 0, GL_RGBA, GL_UNSIGNED_BYTE, texture0);
    glTexImage2D(GL_TEXTURE_2D, 1, GL_RGBA, SIZE1, SIZE1, 0, GL_RGBA, GL_UNSIGNED_BYTE, texture1);
    glTexImage2D(GL_TEXTURE_2D, 2, GL_RGBA, SIZE2, SIZE2, 0, GL_RGBA, GL_UNSIGNED_BYTE, texture2);
    glTexImage2D(GL_TEXTURE_2D, 3, GL_RGBA, SIZE3, SIZE3, 0, GL_RGBA, GL_UNSIGNED_BYTE, texture3);
    glTexImage2D(GL_TEXTURE_2D, 4, GL_RGBA, SIZE4, SIZE4, 0, GL_RGBA, GL_UNSIGNED_BYTE, texture4);
    glTexImage2D(GL_TEXTURE_2D, 5, GL_RGBA, SIZE5, SIZE5, 0, GL_RGBA, GL_UNSIGNED_BYTE, texture5);
    glTexImage2D(GL_TEXTURE_2D, 6, GL_RGBA, SIZE6, SIZE6, 0, GL_RGBA, GL_UNSIGNED_BYTE, texture6);
    glTexImage2D(GL_TEXTURE_2D, 7, GL_RGBA, SIZE7, SIZE7, 0, GL_RGBA, GL_UNSIGNED_BYTE, texture7);
    glTexImage2D(GL_TEXTURE_2D, 8, GL_RGBA, SIZE8, SIZE8, 0, GL_RGBA, GL_UNSIGNED_BYTE, texture8);
}
...
void display() {
    ...
    glVertex3f(-30, 0.0, -60);
    glTexCoord2f(3.0, 0.0);
    glVertex3f(30, 0.0, -60);
    glTexCoord2f(3.0, 3.0);
    glVertex3f(30, 0.0, 60);
    glTexCoord2f(0.0, 3.0);
    glVertex3f(-30, 0.0, 60.0);
    glEnd();
    /*-------Draw the 2nd floor ----*/
